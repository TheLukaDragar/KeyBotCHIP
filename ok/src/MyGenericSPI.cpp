...
//spi is defined in SPI.h so we dont need to defien it here
...
//      SPI.setClockSpeed(1, MHZ);
  ...
  SPI.begin(divider, bitOrder, dataMode);
    ...
    SPI.begin(frequency, bitOrder, dataMode);
#else
 #warning MyGenericSPI does not support this platform yet. Consider adding it and contributing a patch.
#endif
